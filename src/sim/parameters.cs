...
namespace Sim
{
   public class ParameterDatabase
   {
      ...
      public ParameterDatabase()
      {
         ...
         //add complex data type encoder/decoders
         LuaExt.extendLua(myVm);
      }

      public bool init(Initializer init)
      {
         //read in templates
         String path = (String)init.findDataOr("simulation.dataDir", "../data/simulation");
         ...
         foreach (String file in System.IO.Directory.GetFiles(path + "/entity"))
         {
