...
namespace Graphics
{
   public class BobSkinnedModelDescriptor : ResourceDescriptor
   {
      public BobSkinnedModelDescriptor(string descriptorFilename)
         : base()
      {
   ...
   public class BobSkinnedModelLoader
   {
      ...
      public BobSkinnedModelLoader(ResourceManager mgr)
      {
