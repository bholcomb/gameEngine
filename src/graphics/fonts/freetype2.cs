...
namespace FreeType
{
   ...
   public class FT
   {
      ...
      [DllImport(FT_DLL, EntryPoint = "FT_Init_FreeType", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Init_FreeType(out IntPtr /*IntPtr LibraryRec_*/ alibrary);

      [DllImport(FT_DLL, EntryPoint = "FT_Library_Version", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(FT_DLL, EntryPoint = "FT_Done_FreeType", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Done_FreeType(IntPtr /*LibraryRec_*/ library);

      [DllImport(FT_DLL, EntryPoint = "FT_New_Face", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(FT_DLL, EntryPoint = "FT_New_Memory_Face", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(FT_DLL, EntryPoint = "FT_Open_Face", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Open_Face(IntPtr /*LibraryRec_*/ library, Open_Args args, int face_index, IntPtr /*IntPtr FaceRec*/ aface);

      [DllImport(FT_DLL, EntryPoint = "FT_Attach_File", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Attach_File(IntPtr /*FaceRec*/ face, string filepathname);

      [DllImport(FT_DLL, EntryPoint = "FT_Attach_Stream", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Attach_Stream(IntPtr /*FaceRec*/ face, ref Open_Args parameters);

      [DllImport(FT_DLL, EntryPoint = "FT_Done_Face", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Done_Face(IntPtr /*FaceRec*/ face);

      [DllImport(FT_DLL, EntryPoint = "FT_Set_Char_Size", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(FT_DLL, EntryPoint = "FT_Set_Pixel_Sizes", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Set_Pixel_Sizes(IntPtr /*FaceRec*/ face, uint pixel_width, uint pixel_height);

      [DllImport(FT_DLL, EntryPoint = "FT_Load_Glyph", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Load_Glyph(IntPtr /*FaceRec*/ face, uint glyph_index, int load_flags);

      [DllImport(FT_DLL, EntryPoint = "FT_Load_Char", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Load_Char(IntPtr /*FaceRec*/ face, uint char_code, int load_flags);

      [DllImport(FT_DLL, EntryPoint = "FT_Set_Transform", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void Set_Transform(IntPtr /*FaceRec*/ face, ref Matrix matrix, ref Vector delta);

      [DllImport(FT_DLL, EntryPoint = "FT_Render_Glyph", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Render_Glyph(ref GlyphSlotRec slot, Render_Mode render_mode);

      [DllImport(FT_DLL, EntryPoint = "FT_Get_Kerning", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(FT_DLL, EntryPoint = "FT_Get_Glyph_Name", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Get_Glyph_Name(IntPtr /*FaceRec*/ face, uint glyph_index, IntPtr buffer, uint buffer_max);

      [DllImport(FT_DLL, EntryPoint = "FT_Get_Postscript_Name", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr /*sbyte*/ Get_Postscript_Name(IntPtr /*FaceRec*/ face);

      [DllImport(FT_DLL, EntryPoint = "FT_Select_Charmap", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Select_Charmap(IntPtr /*FaceRec*/ face, Encoding encoding);

      [DllImport(FT_DLL, EntryPoint = "FT_Set_Charmap", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Set_Charmap(IntPtr /*FaceRec*/ face, ref CharMapRec charmap);

      [DllImport(FT_DLL, EntryPoint = "FT_Get_Charmap_Index", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int Get_Charmap_Index(ref CharMapRec charmap);

      [DllImport(FT_DLL, EntryPoint = "FT_Get_Char_Index", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern uint Get_Char_Index(IntPtr /*FaceRec*/ face, uint charcode);

      [DllImport(FT_DLL, EntryPoint = "FT_Get_First_Char", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern uint Get_First_Char(IntPtr /*FaceRec*/ face, [In, Out] uint[] agindex);

      [DllImport(FT_DLL, EntryPoint = "FT_Get_Next_Char", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern uint Get_Next_Char(IntPtr /*FaceRec*/ face, uint char_code, [In, Out] uint[] agindex);

      [DllImport(FT_DLL, EntryPoint = "FT_Get_Name_Index", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern uint Get_Name_Index(IntPtr /*FaceRec*/ face, [In, Out] sbyte[] glyph_name);

      [DllImport(FT_DLL, EntryPoint = "FT_MulDiv", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int MulDiv(int a, int b, int c);

      [DllImport(FT_DLL, EntryPoint = "FT_MulFix", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int MulFix(int a, int b);

      [DllImport(FT_DLL, EntryPoint = "FT_DivFix", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int DivFix(int a, int b);

      [DllImport(FT_DLL, EntryPoint = "FT_RoundFix", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int RoundFix(int a);

      [DllImport(FT_DLL, EntryPoint = "FT_CeilFix", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int CeilFix(int a);

      [DllImport(FT_DLL, EntryPoint = "FT_FloorFix", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int FloorFix(int a);

      [DllImport(FT_DLL, EntryPoint = "FT_Vector_Transform", CallingConvention=CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
