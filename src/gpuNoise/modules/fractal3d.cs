...
namespace GpuNoise
{
	public class Fractal3d : Module
	{
		...
		public Fractal3d(int x, int y) : base(Type.Fractal3d, x, y)
		{
			output = new Texture(x, y, PixelInternalFormat.R32f);
         output.setName("Fractal output");

			List<ShaderDescriptor> shadersDesc = new List<ShaderDescriptor>();
			shadersDesc.Add(new ShaderDescriptor(ShaderType.ComputeShader, "GpuNoise.shaders.fbm3d-cs.glsl"));
