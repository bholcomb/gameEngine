...
namespace Noise
{
    public static class Mapping
    {
        ...
        public static void Map2D(MappingMode mappingMode, Double[,] array, ModuleBase module, MappingRanges ranges, Double z)
        {
        ...
        public static void Map2DNoZ(MappingMode mappingMode, Double[,] array, ModuleBase module, MappingRanges ranges)
        {
            var width = array.GetLength(0);
            var height = array.GetLength(1);
        ...
        public static void Map3D(MappingMode mappingMode, Double[, ,] array, ModuleBase module, MappingRanges ranges)
        {
            var width = array.GetLength(0);
            var height = array.GetLength(1);
