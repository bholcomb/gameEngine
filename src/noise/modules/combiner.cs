...
namespace Noise
{
    public sealed class Combiner : ModuleBase
    {
        private readonly HashSet<ModuleBase> sources = new HashSet<ModuleBase>();
        ...
        public void AddSource(ModuleBase module)
        {
            this.sources.Add(module);
        }

        public void RemoveSource(ModuleBase module)
        {
