...
namespace Noise
{
    public sealed class Fractal : ModuleBase
    {
        private readonly BasisFunction[] basisFunctions = new BasisFunction[Noise.MAX_SOURCES];

        private readonly ModuleBase[] sources = new ModuleBase[Noise.MAX_SOURCES];
        ...
        public Fractal(FractalType fractalType, BasisType basisType, InterpolationType interpolationType)
        {
            this.Octaves = 8;
            this.Frequency = 1.00;
        ...
        public void SetAllSourceTypes(BasisType newBasisType, InterpolationType newInterpolationType)
        {
            ...
            {
                this.basisFunctions[i] = new BasisFunction(newBasisType, newInterpolationType);
            }
        }
        ...
        public void SetSourceOverride(Int32 which, ModuleBase newSource)
        {
        ...
        public BasisFunction GetBasis(Int32 which)
        {
