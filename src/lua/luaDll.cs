...
namespace Lua
{
   ...
   public static class LuaDLL
   {
      ...
      static LuaDLL()
      {
         theLuaDll = new DllLoader(LUA_DLL);
      }
...
*/
      ...
      [DllImport(LUA_DLL, EntryPoint = "lua_absindex", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_absindex(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_gettop", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_gettop(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "lua_settop", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_settop(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushvalue", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_pushvalue(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_rotate", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_rotate(IntPtr state, int idx, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_copy", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_copy(IntPtr state, int fromidx, int toidx);

      [DllImport(LUA_DLL, EntryPoint = "lua_checkstack", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_checkstack(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_xmove", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      [DllImport(LUA_DLL, EntryPoint = "lua_isnumber", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_isnumber(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_isstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_isstring(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_iscfunction", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_iscfunction(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_isinteger", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_isinteger(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_isuserdata", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_isuserdata(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_type", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_type(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_typename", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr lua_typename(IntPtr state, int tp);

      [DllImport(LUA_DLL, EntryPoint = "lua_tonumberx", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern double lua_tonumberx(IntPtr state, int idx, IntPtr isnum);

      [DllImport(LUA_DLL, EntryPoint = "lua_tointegerx", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern Int64 lua_tointegerx(IntPtr state, int idx, IntPtr isnum);

      [DllImport(LUA_DLL, EntryPoint = "lua_toboolean", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_toboolean(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_tolstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr lua_tolstring(IntPtr state, int idx, IntPtr len);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawlen", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_rawlen(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_tocfunction", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern LuaCSFunction lua_tocfunction(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_touserdata", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr lua_touserdata(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_tothread", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr lua_tothread(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_topointer", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
LUA_API int   (lua_compare) (lua_State *L, int idx1, int idx2, int op);
      ...
      [DllImport(LUA_DLL, EntryPoint = "lua_arith", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_arith(IntPtr state, int op);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawequal", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_rawequal(IntPtr state, int idx1, int idx2);

      [DllImport(LUA_DLL, EntryPoint = "lua_compare", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      ...
      [DllImport(LUA_DLL, EntryPoint = "lua_pushnil", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_pushnil(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushnumber", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_pushnumber(IntPtr state, double n);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushinteger", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_pushinteger(IntPtr state, Int64 n);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushlstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      private static extern IntPtr lua_pushlstring(IntPtr state, String s, int l);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr lua_pushstring(IntPtr state, String s);

// not implemented
//       [DllImport(LUA_DLL, EntryPoint = "lua_pushvfstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
//       public static extern IntPtr lua_pushvfstring(IntPtr state, String s);

//       [DllImport(LUA_DLL, EntryPoint = "lua_pushfstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
//       public static extern IntPtr lua_pushfstring(IntPtr state, String s);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushcclosure", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_pushcclosure(IntPtr state, LuaCSFunction func, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushboolean", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_pushboolean(IntPtr state, int b);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushlightuserdata", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_pushlightuserdata(IntPtr state, IntPtr p);

      [DllImport(LUA_DLL, EntryPoint = "lua_pushthread", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      [DllImport(LUA_DLL, EntryPoint = "lua_getglobal", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_getglobal(IntPtr state, String name);

      [DllImport(LUA_DLL, EntryPoint = "lua_gettable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_gettable(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_getfield", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_getfield(IntPtr state, int idx, string k);

      [DllImport(LUA_DLL, EntryPoint = "lua_geti", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_geti(IntPtr state, int idx, Int64 n);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawget", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_rawget(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawgeti", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_rawgeti(IntPtr state, int idx, Int64 n);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawgetp", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_rawgetp(IntPtr state, int idx, IntPtr p);

      [DllImport(LUA_DLL, EntryPoint = "lua_createtable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_createtable(IntPtr state, int narr, int nrec);

      [DllImport(LUA_DLL, EntryPoint = "lua_newuserdata", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr lua_newuserdata(IntPtr state, int sz);

      [DllImport(LUA_DLL, EntryPoint = "lua_getmetatable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_getmetatable(IntPtr state, int objindex);

      [DllImport(LUA_DLL, EntryPoint = "lua_getuservalue", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      [DllImport(LUA_DLL, EntryPoint = "lua_setglobal", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_setglobal(IntPtr state, String name);

      [DllImport(LUA_DLL, EntryPoint = "lua_settable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_settable(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_setfield", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_setfield(IntPtr state, int idx, String k);

      [DllImport(LUA_DLL, EntryPoint = "lua_seti", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_seti(IntPtr state, int idx, Int64 n);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawset", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_rawset(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawseti", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_rawseti(IntPtr state, int idx, Int64 n);

      [DllImport(LUA_DLL, EntryPoint = "lua_rawsetp", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_rawsetp(IntPtr state, int idx, IntPtr p);

      [DllImport(LUA_DLL, EntryPoint = "lua_setmetatable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_setmetatable(IntPtr state, int objindex);

      [DllImport(LUA_DLL, EntryPoint = "lua_setuservalue", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      ...
      [DllImport(LUA_DLL, EntryPoint = "lua_callk", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(LUA_DLL, EntryPoint = "lua_load", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_load(IntPtr state, lua_Reader reader, IntPtr dt, string chunkname, string mode);

      [DllImport(LUA_DLL, EntryPoint = "lua_dump", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      [DllImport(LUA_DLL, EntryPoint = "lua_yieldk", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_yieldk(IntPtr state, int nresults, IntPtr ctx, LuaContinuationFunction k);

      [DllImport(LUA_DLL, EntryPoint = "lua_resume", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_resume(IntPtr state, IntPtr from, int narg);

      [DllImport(LUA_DLL, EntryPoint = "lua_status", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_status(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "lua_isyieldable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(LUA_DLL, EntryPoint = "lua_gc", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      [DllImport(LUA_DLL, EntryPoint = "lua_error", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_error(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "lua_next", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_next(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "lua_concat", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_concat(IntPtr state, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_len", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void lua_len(IntPtr state, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_stringtonumber", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_stringtonumber(IntPtr state, String s);

      [DllImport(LUA_DLL, EntryPoint = "lua_getallocf", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern lua_Alloc lua_getallocf(IntPtr state, IntPtr ppud);

      [DllImport(LUA_DLL, EntryPoint = "lua_setallocf", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      ...
      [DllImport(LUA_DLL, EntryPoint = "lua_getstack", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_getstack(IntPtr state, int level, IntPtr debug);

      [DllImport(LUA_DLL, EntryPoint = "lua_getinfo", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_getinfo(IntPtr state, String what, IntPtr debug);

      [DllImport(LUA_DLL, EntryPoint = "lua_getlocal", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String lua_getlocal(IntPtr state, IntPtr debug, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_setlocal", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String lua_setlocal(IntPtr state, IntPtr debug, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_getupvalue", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String lua_getupvalue(IntPtr state, int funcIndex, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_setupvalue", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String lua_setupvalue(IntPtr state, int funcIndex, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_upvalueid", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr lua_upvalueid(IntPtr state, int fidx, int n);

      [DllImport(LUA_DLL, EntryPoint = "lua_upvaluejoin", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String lua_upvaluejoin(IntPtr state, int fidx1, int n1, int fidx2, int n2);

      [DllImport(LUA_DLL, EntryPoint = "lua_sethook", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_sethook(IntPtr state, LuaHookFunction func, int mask, int cout);

      [DllImport(LUA_DLL, EntryPoint = "lua_gethook", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern LuaHookFunction lua_gethook(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "lua_gethookmask", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lua_gethookmask(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "lua_gethookcount", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      ...
      [DllImport(LUA_DLL, EntryPoint = "luaopen_base", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_base(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_coroutine", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_coroutine(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_table", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_table(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_io", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_io(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_os", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_os(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_string", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_string(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_utf8", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_utf8(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_bit32", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_bit32(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_math", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_math(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_debug", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_debug(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaopen_package", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaopen_package(IntPtr state);

      [DllImport(LUA_DLL, EntryPoint = "luaL_openlibs", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
...
*/
      [DllImport(LUA_DLL, EntryPoint = "luaL_checkversion_", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(LUA_DLL, EntryPoint = "luaL_getmetafield", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_getmetafield(IntPtr state, int obj, String name);

      [DllImport(LUA_DLL, EntryPoint = "luaL_callmeta", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_callmeta(IntPtr state, int obj, String name);

      [DllImport(LUA_DLL, EntryPoint = "luaL_tolstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String luaL_tolstring(IntPtr state, int idx, IntPtr len);

      [DllImport(LUA_DLL, EntryPoint = "luaL_argerror", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int lauL_argerror(IntPtr state, int numarg, string extramsg);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checklstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String luaL_checklstring(IntPtr state, int numArg, IntPtr size);

      [DllImport(LUA_DLL, EntryPoint = "luaL_optlstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String luaL_optlstring(IntPtr state, int numArg, String def, IntPtr size);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checknumber", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern double luaL_checknumber(IntPtr state, int numArg);

      [DllImport(LUA_DLL, EntryPoint = "luaL_optnumber", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern double luaL_optnumber(IntPtr state, int numArg, double def);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checkinteger", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern Int64 luaL_checkinteger(IntPtr state, int numArg);

      [DllImport(LUA_DLL, EntryPoint = "luaL_optinteger", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern Int64 luaL_optinteger(IntPtr state, int numArg, int def);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checkstack", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_checkstack(IntPtr state, int sz, String msg);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checktype", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_checktype(IntPtr state, int numArg, int t);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checkany", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_checkany(IntPtr state, int numArg);

      [DllImport(LUA_DLL, EntryPoint = "luaL_newmetatable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_newmetatable(IntPtr state, String s);

      [DllImport(LUA_DLL, EntryPoint = "luaL_setmetatable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_setmetatable(IntPtr state, String s);

      [DllImport(LUA_DLL, EntryPoint = "luaL_testudata", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr luaL_testudata(IntPtr state, int ud, String name);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checkudata", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr luaL_checkudata(IntPtr state, int ud, String name);

      [DllImport(LUA_DLL, EntryPoint = "luaL_where", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_where(IntPtr state, int lvl);

      [DllImport(LUA_DLL, EntryPoint = "luaL_error", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_error(IntPtr state, String s);

      [DllImport(LUA_DLL, EntryPoint = "luaL_checkoption", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_checkoption(IntPtr state, int narg, String def, String[] list);

      [DllImport(LUA_DLL, EntryPoint = "luaL_fileresult", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_fileresult(IntPtr state, int stat, String fname);

      [DllImport(LUA_DLL, EntryPoint = "luaL_execresult", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_execresult(IntPtr state, int stat);

      [DllImport(LUA_DLL, EntryPoint = "luaL_ref", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_ref(IntPtr state, int t);

      [DllImport(LUA_DLL, EntryPoint = "luaL_unref", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_unref(IntPtr state, int t, int Ref);

      [DllImport(LUA_DLL, EntryPoint = "luaL_loadfilex", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      ...
      [DllImport(LUA_DLL, EntryPoint = "luaL_loadbufferx", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_loadbufferx(IntPtr state, IntPtr buffer, int bufferSize, String name, String mode);

      [DllImport(LUA_DLL, EntryPoint = "luaL_loadstring", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_loadstring(IntPtr state, String s);

      [DllImport(LUA_DLL, EntryPoint = "luaL_newstate", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern IntPtr luaL_newstate();

      [DllImport(LUA_DLL, EntryPoint = "luaL_len", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern Int64 luaL_len(IntPtr state, int idx);

      [DllImport(LUA_DLL, EntryPoint = "luaL_gsub", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern String luaL_gsub(IntPtr state, String s, String p, String r);

      [DllImport(LUA_DLL, EntryPoint = "luaL_setfuncs", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_setfuncs(IntPtr state, IntPtr luaReg, int nup);

      [DllImport(LUA_DLL, EntryPoint = "luaL_getsubtable", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern int luaL_getsubtable(IntPtr state, int idx, String fname);

      [DllImport(LUA_DLL, EntryPoint = "luaL_traceback", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
      public static extern void luaL_traceback(IntPtr state, IntPtr L1, String msg, int level);

      [DllImport(LUA_DLL, EntryPoint = "luaL_requiref", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
